            ...
            <div className="rounded-md shadow-sm">
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  required
                  className="relative block w-full px-3 py-2 text-gray-900 placeholder-gray-500 bg-gray-200 border border-gray-300 focus:outline-none focus:ring-neon focus:border-neon focus:z-10 sm:text-sm"
